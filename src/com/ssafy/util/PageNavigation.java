...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		builder.append("				<a href=\"#\" class=\"page-link\" id=\"pageNav\">최신</a> \n");
		builder.append("			</li> \n");
		builder.append("			<li class=\"page-item\" data-pg=\"" + (this.startRange ? 1 : (startPage - 1)) + "\"> \n");
		builder.append("				<a href=\"#\" class=\"page-link\" id=\"pageNav\">이전</a> \n");
		builder.append("			</li> \n");
		for(int i=startPage;i<=endPage;i++) {
			builder.append("			<li class=\"" + "page-item" + "\" data-pg=\"" + i + "\"><a href=\"#\" class=\"" + "page-link" + (currentPage == i ? " active" : " ")+ "\" id=\"pageNav\">" + i + "</a></li> \n");
		}
		builder.append("			<li class=\"page-item\" data-pg=\"" + (this.endRange ? endPage : (endPage + 1)) + "\"> \n");
		builder.append("				<a href=\"#\" class=\"page-link\" id=\"pageNav\">다음</a> \n");
		builder.append("			</li> \n");
		builder.append("			<li class=\"page-item\" data-pg=\"" + totalPageCount + "\"> \n");
		builder.append("				<a href=\"#\" class=\"page-link\" id=\"pageNav\" >마지막</a> \n");
		builder.append("			</li> \n");
		builder.append("		</ul> \n");
